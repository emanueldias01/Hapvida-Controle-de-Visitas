...
public class ValidacaoVisitante {
    ...
    protected boolean validaVisitantesDuplicados(VisitanteRequestDTO data) {
        ...
        var idPaciente = pacienteRepository.findById(data.pacienteId()).get();
        var paciente = pacienteRepository.findByNome(idPaciente.getNome());
    ...
    protected boolean validaQuantidadeDePessoasNoLeito(VisitanteRequestDTO data) {
        ...
        List<Visitante> listaDeVisitantesDoPaciente = visitanteRepository.findByPacienteId(data.pacienteId());
